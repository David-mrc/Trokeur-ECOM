...
public class TrockeurUserResource {
     ...
     *         body the new trockeurUser, or with status {@code 400 (Bad Request)}
     *         if the trockeurUser has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/trockeur-users")
    public ResponseEntity<TrockeurUser> createTrockeurUser(@Valid @RequestBody TrockeurUser trockeurUser)
     ...
     *         the updated trockeurUser,
     *         or with status {@code 400 (Bad Request)} if the trockeurUser is not
     *         valid,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         trockeurUser couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/trockeur-users/{id}")
    public ResponseEntity<TrockeurUser> updateTrockeurUser(
            @PathVariable(value = "id", required = false) final Long id,
            @Valid @RequestBody TrockeurUser trockeurUser) throws URISyntaxException {
        ...
        return ResponseEntity
                ...
                .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME,
                        trockeurUser.getId().toString()))
                .body(result);
    }

    /**
     * {@code PATCH  /trockeur-users/:id} : Partial updates given fields of an
     * existing trockeurUser, field will ignore if it is null
     *
     * @param id           the id of the trockeurUser to save.
     * @param trockeurUser the trockeurUser to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     ...
     *         or with status {@code 400 (Bad Request)} if the trockeurUser is not
     *         valid,
     *         or with status {@code 404 (Not Found)} if the trockeurUser is not
     *         found,
     *         or with status {@code 500 (Internal Server Error)} if the
     *         trockeurUser couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
    ...
    public ResponseEntity<TrockeurUser> partialUpdateTrockeurUser(
            @PathVariable(value = "id", required = false) final Long id,
            @NotNull @RequestBody TrockeurUser trockeurUser) throws URISyntaxException {
     ...
     *         of trockeurUsers in body.
     */
    @GetMapping("/trockeur-users")
    public List<TrockeurUser> getAllTrockeurUsers(
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the trockeurUser, or with status {@code 404 (Not Found)}.
     */
    ...
    /**
     * {@code GET  /current-trockeur-user-id} : get the current (authenticated)
     * trockeurUser id.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the trockeurUser, or with status {@code 404 (Not Found)}.
    ...
    public ResponseEntity<Long> getCurrentTrockeurUser() {
        ...
        Optional<Long> currentTrockeurUserId = trockeurUserRepository
                .findTrockeurUserIdByLogin(SecurityUtils.getCurrentUserLogin());
        return ResponseUtil.wrapOrNotFound(currentTrockeurUserId);
    }

    /**
     * {@code GET  /current-trockeur-user-id/:id} : get the user of a trockeur user
     * id.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the trockeurUser, or with status {@code 404 (Not Found)}.
    ...
    /**
     * {@code GET  /user-by-login/:login} : get the email of user by login.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the trockeurUser, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/user-by-login/{login}")
    public ResponseEntity<User> getTrockeurUserByLogin(@PathVariable String login) {
        log.debug("REST request to get the email of user by login : ", login);
        Optional<User> user = trockeurUserRepository.findUserBylogin(Optional.of(login));
        return ResponseUtil.wrapOrNotFound(user);
    }
